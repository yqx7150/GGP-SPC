...
def parse_args_and_config():
    ...
    parser.add_argument('--exe', type=str, default='GGP_EXE', help='The model to execute')
    parser.add_argument('--config', type=str, default='ggp.yml',  help='Path to the config file')
    ...
    # parse config file
    if not args.test:
        with open(os.path.join('GGP/configs', args.config), 'r') as f:
            config = yaml.load(f)
